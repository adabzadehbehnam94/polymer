                    ...
                    <div className="swiper-slide">
                        <div className="text-white relative">
                            <div className="absolute top-20 right-40 w-100 ">
                                ...
                                <button className="ml-5 bg-black px-5 py-3 text-[#87898f] rounded-md border-2 border-[#87898f] text-sm hover:bg-[#3b9821] hover:border-[#3b9821] hover:text-white cursor-pointer ">مشاهده محصولات</button>
                                <button className=" px-5 bg-black py-3 rounded-md text-[#87898f] border-2 border-[#87898f] text-sm hover:bg-[#3b9821] hover:border-[#3b9821] hover:text-white transition delay-150 cursor-pointer">تماس با ما</button>
                            </div>  
