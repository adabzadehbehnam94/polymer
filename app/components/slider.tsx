            ...
            >
                ...
                {sliderData.map((item: sliderType) => (
                    <SwiperSlide key={item.id}>
                        ...
                        >
                            <div className=" md:w-100 order-last md:order-first mx-auto ">
                                <h1 className="md:text-3xl md:mb-5 mb-3 text-center md:text-start">{item.title}</h1>
                                {item?.subtitle && <p className="md:text-sm text-[#b9bab8] text-xs md:mb-5 mb-3 text-center md:text-start">{item.subtitle}</p>}
