...
export default function Sidebar(props : {click?: ()=> void}) {
    ...
    return (
        <section className="flex gap-2 flex-col w-50  sm:border-l-2 sm:border-gray-300">
            ...
            <Link onClick={props.click} className="flex flex-row mb-5 w-[fit-content]" href={"/dashboard/articles"}><Image className="ml-3" src={article} alt="icon" width={20} height={20} />مقالات</Link>
