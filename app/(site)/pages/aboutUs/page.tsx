    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 py-5 rounded-lg border-2 border-[#10201E]  relative">
                <div
                    className="flex tems-center gap-2 absolute top-0 outline-2 outline-[#0b1113] text-white left-[42%] bg-[#0b1113]  rounded-lg">
                ...
                <div className="border-l-2 border-[#10201E]">
