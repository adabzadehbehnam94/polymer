...
export default function AdsPage({ data }: { data: SliderItem[] }) {
    ...
    return (
        <div className="flex flex-col">
            ...
            <button className="bg-blue-500 rounded-md text-white hover:bg-blue-700 px-2 py-1 cursor-pointer mt-5 w-40" onClick={() => router.push("/dashboard/sliderAds/addSlider")}>ایجاد تبلیغ جدید</button>
            <ToastContainer />
        </div>
    )
}