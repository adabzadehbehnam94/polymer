...
import { allCategories, allCustomers, allProducts, allUsers } from "@/app/components/serverAction";
// type User = {
//     name ? : string , 
//     count? : number
// }[]
...
export default  function Overview() {
    ...
    return (
        <div className="grid md:grid-cols-3">
                        <p className="border-b-2 py-3 md:py-0 border-gray-300 md:border-none text-gray-">تعداد مشتریان : {parseInt(customers?.length).toLocaleString("fa-IR")}</p>
